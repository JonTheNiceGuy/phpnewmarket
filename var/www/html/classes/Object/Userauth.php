...
class Object_Userauth extends Abstract_GenericObject
{
    ...
    protected $arrDBItems = array(
        ...
        'enumAuthType' => array('type' => 'enum', 'options' => array('basicauth', 'codeonly', 'onetime'), 'unique' => true, 'required' => 'user'),
