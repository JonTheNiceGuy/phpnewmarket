...
class Object_ChangeLog extends Abstract_GenericObject
{
     ...
     * @return Object_Input
     */
    public static function brokerByID($intID = 0)
    {
        if (Object_User::isSystem()) {
     ...
     * @return array The array of objects matching this search
     */
    public static function brokerByColumnSearch($column = null, $value = null, $inverse = false, $json = false, $count = null, $direction = 'ASC', $like = false)
    {
        if (Object_User::isSystem()) {
            return parent::brokerByColumnSearch($column, $value, $inverse, $json, $count, $direction, $like);
        } else {
            return false;
        }
    }
